...
print(const char *s)
{
  ...
  20:	318080e7          	jalr	792(ra) # 334 <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	38650513          	addi	a0,a0,902 # 3c0 <getprocs+0xc>
  ...
  54:	2bc080e7          	jalr	700(ra) # 30c <fork>
    if(pid < 0)
  ...
  68:	36c50513          	addi	a0,a0,876 # 3d0 <getprocs+0x1c>
  6c:	00000097          	auipc	ra,0x0
  70:	f94080e7          	jalr	-108(ra) # 0 <print>
    exit(1);
  74:	4505                	li	a0,1
  76:	00000097          	auipc	ra,0x0
  7a:	29e080e7          	jalr	670(ra) # 314 <exit>
      exit(0);
  ...
  98:	288080e7          	jalr	648(ra) # 31c <wait>
  ...
  aa:	276080e7          	jalr	630(ra) # 31c <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	36c50513          	addi	a0,a0,876 # 420 <getprocs+0x6c>
  ...
  d4:	32050513          	addi	a0,a0,800 # 3f0 <getprocs+0x3c>
  d8:	00000097          	auipc	ra,0x0
  dc:	f28080e7          	jalr	-216(ra) # 0 <print>
      exit(1);
  e0:	4505                	li	a0,1
  e2:	00000097          	auipc	ra,0x0
  e6:	232080e7          	jalr	562(ra) # 314 <exit>
    print("wait got too many\n");
  ea:	00000517          	auipc	a0,0x0
  ee:	31e50513          	addi	a0,a0,798 # 408 <getprocs+0x54>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	218080e7          	jalr	536(ra) # 314 <exit>
...
main(void)
{
 ...
 11a:	1fe080e7          	jalr	510(ra) # 314 <exit>
...
gets(char *buf, int max)
{
 ...
 210:	120080e7          	jalr	288(ra) # 32c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 262:	0f6080e7          	jalr	246(ra) # 354 <open>
  if(fd < 0)
 ...
 272:	0fe080e7          	jalr	254(ra) # 36c <fstat>
 276:	892a                	mv	s2,a0
  close(fd);
 278:	8526                	mv	a0,s1
 27a:	00000097          	auipc	ra,0x0
 27e:	0c2080e7          	jalr	194(ra) # 33c <close>
  return r;
}
 282:	854a                	mv	a0,s2
